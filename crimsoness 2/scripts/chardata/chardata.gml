function chardata(name_="drip", displayname_="among", sprite_=s_null, talksound_=se_null, textspeed_=.5, font_=ft_lucidiasans, step_=talkcharstep, draw_=talkchardraw, texteffects_=[], namecolor_=c_white) constructor {
	name = name_;
